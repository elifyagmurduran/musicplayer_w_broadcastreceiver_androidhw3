...
import com.learning.musicplayer.Player;
...
public class MusicPlayerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songsList = (ArrayList<SongFile>) getIntent().getSerializableExtra("LIST");
            ...
            public void run() {
                if(mediaPlayer!=null){
                    ...
                    if(mediaPlayer.isPlaying()){
                        ...
                        pausePlay.setImageResource(R.drawable.ic_baseline_play_24);
    ...
    void setResourcesWithMusic(){
        currentSong = songsList.get(Player.currentIndex);
    ...
    private void playNextSong(){
        ...
        if(Player.currentIndex== songsList.size()-1)
            return;
